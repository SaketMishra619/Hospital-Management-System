...
<body>
	...
	<div class="two">
		<h3 style="text-align: center;">Update Patient</h3>
		<form action="#" method="post">
			...
			<tr>
				<td><input type="submit" value="Update"  style="border: 1px solid #eee; border-radius:20px;  background-color: black; font:bold 15px arial,sans-serif; height:40px; width:80px; color: white "></td>
			</tr>
		</table>
		</form>	
